            ...
            for (var i in cartArray){
                ...
                <input type='hidden' name="+'name-'+[i]+" value="+ cartArray[i].name +">\n\
                   <div class='quantityContainer'>\n\
                     <input type='hidden' name="+'name-'+[i]+" value="+ cartArray[i].price +">\n\
                </div>\n\
                                       </div>";
            ...
            for (var i in cartArray) {
                output += "<div class='cart-each-product'>\n\
                       ...
                       <div class='quantityContainer'>\n\
                        ...
                        <div class='btnx'>\n\
                        <button type='button' class='form-control sc-remove' data-name='" + cartArray[i].name + "' data-price='" + cartArray[i].price + "' min='0' value=" + cartArray[i].count + " name='btnx'><i class='fas fa-2x fa-times'></i>\n\
                   </div></button>\n\
                       </div>";
