$(document).ready(function(){
    ...
    $('.adsp').click(function(){
         ...
         var spke=0;
         $('.adsp').hide();
       $('.spc').append('<li id="spk'+spke+'" style="margin-bottom: .5rem;"><input id="sp1" type="text" size="50" value="" placeholder="13+2MP dual rear AI camera with PDAF | 8MP front camera" ></li>\n\
       <div class="col-md-6" style="margin-left: -2em;">\n\
            <button  class="btn btn-warning btn-sm btn-block mt-3 sc-add-to-cart svsp">\n\
              <i class="fas fa-plus float-left text-primary" style="font-size: 25px;"></i>\n\
              Save\n\
            </button></div>\n\
       '),
